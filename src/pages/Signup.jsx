      ...
      <div style={{ position:'relative',zIndex:1,padding:'48px',display:'flex',flexDirection:'column',height:'100%' }}>
        ...
        <div style={{ marginBottom:'auto' }}>
          <h1 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:'clamp(2.5rem,4vw,4.5rem)',lineHeight:0.88,letterSpacing:'-0.035em',color:'#e8e6e3',margin:'0 0 20px 0' }}>
            JOIN THE<br /><span style={{ color:'#00d4aa' }}>PEACE</span><br />MOVEMENT.
          </h1>
          <p style={{ fontFamily:'Space Grotesk,sans-serif',fontWeight:300,fontSize:'14px',color:'#555',lineHeight:1.75,margin:'0 0 32px 0',maxWidth:'320px' }}>
            Be part of building India's first Peace Intelligence Platform. Early access supporters shape the roadmap.
          </p>
        ...
        <div style={{ maxWidth:'400px', width:'100%' }}>
          {done ? (
            <div>
              ...
              <h2 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:'clamp(1.5rem,2.5vw,2.2rem)',color:'#e8e6e3',margin:'0 0 12px 0',letterSpacing:'-0.02em' }}>Account created.</h2>
              <p style={{ fontFamily:'JetBrains Mono,monospace',fontSize:'10px',color:'#555',letterSpacing:'0.1em',lineHeight:1.7,marginBottom:'24px' }}>
                Check your email to confirm your address. Once confirmed, you can log in.
              </p>
            ...
            <>
              <div style={{ marginBottom:'40px' }}>
                ...
                <h2 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:'clamp(1.8rem,3vw,2.8rem)',lineHeight:0.92,letterSpacing:'-0.03em',color:'#e8e6e3',margin:0 }}>
                  Join<br /><span style={{ color:'#00d4aa' }}>SETU</span>
                </h2>
              </div>
              ...
              <form onSubmit={handleSignup} style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
                <div>
                  <label style={{ fontFamily:'JetBrains Mono,monospace',fontSize:'9px',color:'#555',letterSpacing:'0.15em',textTransform:'uppercase',display:'block',marginBottom:'8px' }}>Full Name</label>
                  <input
              ...
              <div style={{ marginTop:'28px',display:'flex',justifyContent:'space-between',alignItems:'center' }}>
                <Link to="/login" style={{ fontFamily:'JetBrains Mono,monospace',fontSize:'9px',color:'#555',letterSpacing:'0.1em',textDecoration:'none',transition:'color 0.2s' }}
